...
class NotificationDataProvider {
  static final List<NotificationModel> _cachedNotifications = _createMockData();
  
  // Private constructor để tạo data 1 lần duy nhất
  static List<NotificationModel> _createMockData() {
    ...
    return [
      NotificationModel(
        ...
        metadata: const {'category': 'travel_tips'},
      ),
      NotificationModel(
        id: '2',
        ...
        metadata: const {'category': 'budget_tips'},
      ),
      NotificationModel(
        id: '3',
      ...
      NotificationModel(
        ...
        metadata: const {'category': 'travel_guide'},
      ),
      NotificationModel(
        id: '5',
      ...
      NotificationModel(
        ...
        metadata: const {'category': 'adventure'},
      ),
      NotificationModel(
        id: '8',
      ...
      NotificationModel(
        ...
        metadata: const {'category': 'culture'},
      ),
    ];
  }
